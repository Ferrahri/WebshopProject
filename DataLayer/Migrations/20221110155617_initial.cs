    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7389), "jj123@test.com", true, false, "Jack", "jj123", 123456789, "Johnson", "jjshopper" },
                    { 2, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7392), "rene488@test.com", true, true, "Rene", "rdp123", 987654321, "du Preez", "rene488" },
                    { 3, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7393), "emma30h@test.com", false, false, "Emma", "eh123", 918273645, "Holm", "emma30h" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2, 1, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7294), "Latitude 5530", 6460f, 4, 1 },
                    { 2, 6, 5, 1, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7318), "Ryzen 5 7700X", 3499f, 2, 3 },
                    { 3, 5, 5, 1, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7320), "i5 13700K", 3300f, 3, 4 },
                    { 4, 3, 4, 3, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7321), "EcoBubble", 5999f, 6, 6 },
                    { 5, 4, 4, 4, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7323), "Serie 6 ProAnimal", 2100f, 5, 5 },
                    { 6, 2, 4, 2, new DateTime(2022, 11, 10, 16, 56, 17, 249, DateTimeKind.Local).AddTicks(7324), "Bravia XR", 13999f, 1, 2 }
                });
